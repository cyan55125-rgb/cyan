...
import { Mail, Lock, Eye, EyeOff, Leaf, LogIn, Github } from 'lucide-react';
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12" style={{ background: 'linear-gradient(135deg, #f0f4ff 0%, #faf5ff 50%, #f0fdf4 100%)' }}>
      <motion.div
      ...
      >
        <motion.div variants={itemVariants} className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-emerald-500 shadow-lg shadow-blue-200/50 mb-5">
            <Leaf className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-2xl sm:text-3xl font-bold text-slate-800 font-[Outfit,'Noto Sans SC',sans-serif]">
            欢迎回来
          </h1>
          <p className="mt-2 text-slate-400 text-sm">登录你的知识花园账号，继续学习之旅</p>
        </motion.div>
        ...
        <motion.form
          ...
          noValidate
          className="bg-white rounded-2xl shadow-xl shadow-slate-200/60 p-8 space-y-5 border border-slate-100/80"
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/forgot-password" className="text-sm text-blue-500 hover:text-blue-600 transition-colors font-medium">
              忘记密码？
            </Link>
          </div>
